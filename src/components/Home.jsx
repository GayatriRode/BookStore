...
const testimonials = [
  {
    name: 'Raghav Kumar',
    image: test1,
    quote: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis libero in nunc suscipit, et cursus metus convallis.'
  },
  {
    name: 'Manoj Mishra',
    image: test2,
    quote: 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Sed tristique.'
  },
  {
    name: 'Harshad Atkari',
    image: test3,
...
const Home = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <Section id="testimonials" title="Testimonials" className="text-center text-3xl font-serif mb-8">
